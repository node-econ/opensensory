...
## Ag Tech Benchmarking and ROI Tools

**The audience**: Trade associations, commodity commissions, larger individual producers, ag tech startups and incumbents, startup accelerators/funders

**The idea**: A model to evaluate, prioritize, and monitor investments in crop production and processing technologies. 

**How it works**:
1. Grower chooses a technology to evaluate: mechanization, chemicals, irrigation, potentially anything.
2. They input relevant information about their operations, products, and practices
3. In the background, we have historical data about market pricing, weather, input prices, and standard industry practices
4. The model produces a range of outputs under varying production and market demand scenarios
5. Then, to close the loop, we provide a quantified analysis of financing alternatives, staffing/expertise needs, ROI/payback period, gates/milestones, and other feasibility elements.
...
**Topics**:
- California milling and bottling capacity
- California vs import supply
- Consumer demand: Is growth inevitable? If it is higher or lower, what impact would that have on millers -> growers
- How are SHD growers impacted by Cobram's preferred production system?
	- Long-term leases and supply contracts coming up for renegotiation
	- What investments would be required to transition to new system, or is it time to get out of the market?
- What is the collective financial position of oil olive growers? By geography, varietal.
- What is the competitive position of the remaining millers?
- How do size and geography matter?
- How can growers and millers navigate constraints and take advantage of opportunities?


## Market-Driven Succession Planning
**The problem**: Aside from the deeply personal aspects of succession planning in farming and food businesses, there are conflicting forces to navigate:
...
**Audience**: commodity commissions, PCAs, dealerships, pesticide regulators, agricultural inspectors

**The situation**: Over the past 12 months, Corteva Agriscience, Bayer CropScience, and FMC - which together represent about half of global pesticide sales - have each announced plans to restructure their businesses. 
...
## Crop Alerts, Forecasting, Planning, and Scenario Analysis

**The audience**: Specialty crop producers, trade associations, retail buyers, and agricultural officials

**The problem**: Over the past five years, there have been innumerable disasters affecting specialty crop producers in the U.S., including:
- Weather-related losses in the California cherry industry
- The Pajaro River levee breach and Tulare Lake inundation
- Recurring drought, freeze, and wildfires
- And, most recently, a critical short-term supply shortage in melons from the Arizona-California desert producing regions 

**The Idea**: A business interruption scenario development and simulation tool

**How it Works**: Using widely-available data about land, water, infrastructure, and weather, we can develop scenarios to assist with near-term and long-range planning at an industry, region, company, or even divisional level.
